...
`moderations.create(**kwargs) -> ModerationCreateResponse`
...
- `class ModerationCreateResponse`
  ...
  - `results: Array[Moderation]`
    ...
    - `categories: { harassment, harassment_threatening, hate, 10 more}`
    ...
    - `category_applied_input_types: { harassment, harassment_threatening, hate, 10 more}`
      ...
      - `harassment_threatening: Array[:text]`
      ...
      - `illicit_violent: Array[:text]`

        The applied input type(s) for the category 'illicit/violent'.

        - `:text`

      - `self_harm: Array[:text | :image]`
      ...
      - `self_harm_instructions: Array[:text | :image]`
      ...
      - `self_harm_intent: Array[:text | :image]`
      ...
      - `violence_graphic: Array[:text | :image]`
    ...
    - `category_scores: { harassment, harassment_threatening, hate, 10 more}`
