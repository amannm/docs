...
- `body ChatCompletionNewParams`
  ...
  - `PromptCacheRetention param.Field[ChatCompletionNewParamsPromptCacheRetention]`
    ...
    - `const ChatCompletionNewParamsPromptCacheRetentionInMemory ChatCompletionNewParamsPromptCacheRetention = "in-memory"`
...
- `query ChatCompletionListParams`
  ...
  - `Order param.Field[ChatCompletionListParamsOrder]`
...
- `type ChatCompletionChunk struct{…}`
  ...
  - `Choices []ChatCompletionChunkChoice`
    ...
    - `Logprobs ChatCompletionChunkChoiceLogprobs`
  ...
  - `Object ChatCompletionChunk`
    ...
    - `const ChatCompletionChunkChatCompletionChunk ChatCompletionChunk = "chat.completion.chunk"`
...
- `type ChatCompletionStoreMessage struct{…}`
  ...
  - `ContentParts []ChatCompletionStoreMessageContentPartUnion`
...
- `query ChatCompletionMessageListParams`
  ...
  - `Order param.Field[ChatCompletionMessageListParamsOrder]`
