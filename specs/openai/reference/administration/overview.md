...
To access these endpoints please generate an Admin API Key through the [create admin API key endpoint](../organization.md#create). Admin API keys cannot be used for non-administration endpoints.
