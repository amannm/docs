...
> Source: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/report-entities/customerincome
> Breadcrumbs: [QuickBooks Online API](../../index.md) / [Accounting](../index.md) / [Report entities](index.md) / CustomerIncome
> Canonical entity: `CustomerIncome`
...
- **Operation:** `GET /v3/company/<realmID>/reports/CustomerIncome?<name>=<value>[&...]`
...
Schema: `customerincomequery`

<details>
<summary>Show schema for `customerincomequery`</summary>
