...
> Source: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/report-entities/journalreport
> Breadcrumbs: [QuickBooks Online API](../../index.md) / [Accounting](../index.md) / [Report entities](index.md) / JournalReport
> Canonical entity: `JournalReport`

The information below provides a reference on how to access the journal report from the QuickBooks Online Report Service. For FR locales use [JournalReportFR](../all-entities/journalreportfr.md) instead.
