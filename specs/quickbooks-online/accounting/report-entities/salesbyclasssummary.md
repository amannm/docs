...
> Source: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/report-entities/salesbyclasssummary
> Breadcrumbs: [QuickBooks Online API](../../index.md) / [Accounting](../index.md) / [Report entities](index.md) / SalesByClassSummary
> Canonical entity: `SalesByClassSummary`
...
## The sales by class report object
...
- **Operation:** `GET /v3/company/<realmID>/reports/ClassSales?<name>=<value>[&...]`
...
Schema: `classsalesquery`

<details>
<summary>Show schema for `classsalesquery`</summary>
...
This query returns a report for sales by class.

#### Example

```text
"BaseURL/v3/company/1386066315/reports/ClassSales"
```
