...
> Source: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/report-entities/customerbalance
> Breadcrumbs: [QuickBooks Online API](../../index.md) / [Accounting](../index.md) / [Report entities](index.md) / CustomerBalance
> Canonical entity: `CustomerBalance`
...
- **Operation:** `GET /v3/company/<realmID>/reports/CustomerBalance?<name>=<value>[&...]`
...
Schema: `customerbalancequery`

<details>
<summary>Show schema for `customerbalancequery`</summary>
