...
> Source: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/report-entities/inventoryvaluationsummary
> Breadcrumbs: [QuickBooks Online API](../../index.md) / [Accounting](../index.md) / [Report entities](index.md) / InventoryValuationSummary
> Canonical entity: `InventoryValuationSummary`
...
## The inventory valuation report object
...
- **Operation:** `GET /v3/company/<realmID>/reports/InventoryValuationSummary?<name>=<value>[&...]`
...
Schema: `inventoryvaluationquery`

<details>
<summary>Show schema for `inventoryvaluationquery`</summary>
...
This query returns get the inventory valuation report for this fiscal year-to-date.
