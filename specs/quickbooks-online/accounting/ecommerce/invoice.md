...
> Source: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/ecommerce/invoice
> Breadcrumbs: [QuickBooks Online API](../../index.md) / [Accounting](../index.md) / [E Commerce](index.md) / Invoice
...
Before you can use this field ensure that the company allows deposits in their invoices first. This can be found by querying the [Preferences endpoint](../all-entities/preferences.md). `SalesFormsPrefs.AllowDeposit` must be equal to true. If you do not specify this account the payment is applied to the Undeposited Funds account.
