...
Creates a new [Price](../prices.md) for an existing [Product](../products.md). The Price can be recurring or one-time.

## Returns

The newly created `Price` object is returned upon success. Otherwise, this call raises [an error](create.md#errors).
