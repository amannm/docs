...
- `reserve_hold` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  The ReserveHold this ReserveRelease is associated with.

- `reserve_plan` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
- `source_transaction` (object, nullable)
  ...
  - `source_transaction.dispute` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    The ID of the dispute.

  - `source_transaction.refund` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
