...
- `flat_amount` (integer, required if mode=partial and line_items nor shipping_cost provided)
  A flat amount to reverse across the entire transaction, in the [smallest currency unit](https://docs.stripe.com/docs/currencies.md#minor-units) in negative. This value represents the total amount to refund from the transaction, including taxes.
...
- `line_items` (array of objects, required if mode=partial and neither shipping_cost nor flat_amount is provided)
  ...
  - `line_items.amount` (integer, required)
    The amount to reverse, in the [smallest currency unit](https://docs.stripe.com/docs/currencies.md#minor-units) in negative.

  - `line_items.amount_tax` (integer, required)
    The amount of tax to reverse, in the [smallest currency unit](https://docs.stripe.com/docs/currencies.md#minor-units) in negative.
