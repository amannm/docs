...
Possible enum values:
  ...
  - `payment_method_details.bancontact` (object, nullable)
    ...
    - `payment_method_details.bancontact.generated_sepa_debit` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      The ID of the SEPA Direct Debit PaymentMethod which was generated by this Charge.

    - `payment_method_details.bancontact.generated_sepa_debit_mandate` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
  ...
  - `payment_method_details.boleto` (object, nullable)
    ...
    - `payment_method_details.boleto.tax_id` (string, nullable)
...
Possible enum values:
    ...
    - `payment_method_details.card.checks` (object, nullable)
      ...
      - `payment_method_details.card.checks.address_line1_check` (enum, nullable)
        If you provide a value for `address.line1`, the check result is one of `pass`, `fail`, `unavailable`, or `unchecked`.

      - `payment_method_details.card.checks.address_postal_code_check` (enum, nullable)
        If you provide a address postal code, the check result is one of `pass`, `fail`, `unavailable`, or `unchecked`.

      - `payment_method_details.card.checks.cvc_check` (enum, nullable)
...
Possible enum values:
          - `bonus`
            Bonus installment plan.

          - `fixed_count`
            Fixed count installment plan.

          - `revolving`
            Revolving installment plan.
...
Possible enum values:
        ...
        - `frictionless`
          The issuer authenticated your customer through the 3D Secure 2 frictionless flow.

      - `payment_method_details.card.three_d_secure.result` (enum, nullable)
        Indicates the outcome of 3D Secure authentication.
Possible enum values:
        - `attempt_acknowledged`
          The issuing bank doesn’t support 3D Secure, hasn’t enabled it for the card, or is experiencing an outage. No authentication occured, but the card network provided proof of the attempt.

          In most cases, the attempt qualifies for liability shift, and you can proceed with the payment.

        - `authenticated`
          3D Secure authentication succeeded.

        - `exempted`
          A 3D Secure exemption applies to this transaction. You or the network might request an exemption for business initiation, low value, or low risk.

        - `failed`
          The customer failed 3D Secure authentication.

        - `not_supported`
          This card doesn’t support 3D Secure authentication. Liability usually doesn’t shift to the issuer.

        - `processing_error`
          The issuing bank’s 3D Secure system is temporarily unavailable, and the card network can’t provide proof of the attempt. Liability usually doesn’t shift to the issuer.

      - `payment_method_details.card.three_d_secure.result_reason` (enum, nullable)
        Additional information about why 3D Secure succeeded or failed, based on the `result`.
Possible enum values:
        - `abandoned`
          For `failed`: The transaction timed out because the cardholder dropped off before completing authentication.

        - `bypassed`
          For `processing_error`: Stripe bypassed 3D Secure because the issuer’s server returned errors or timeouts during the challenge.

        - `canceled`
          For `failed`: The cardholder canceled authentication when identifiable.

        - `card_not_enrolled`
          For `not_supported`: The issuing bank doesn’t support 3D Secure or hasn’t enabled it for the card, and the card network didn’t provide proof of the attempt.

          This can occur with some prepaid cards and in rare cases where the issuing bank is exempt from supporting 3D Secure.

        - `network_not_supported`
          For `not_supported`. Stripe doesn’t support 3D Secure on this card network.

        - `protocol_error`
          For `processing_error`: The card network or issuing bank sent an invalid message. This includes “downgrades” and similar errors.

        - `rejected`
          For `failed`: The issuing bank redirected the cardholder back without completing authentication.
...
Possible enum values:
  ...
  - `payment_method_details.card_present` (object, nullable)
    ...
    - `payment_method_details.card_present.location` (string, nullable)
...
Possible enum values:
    ...
    - `payment_method_details.card_present.reader` (string, nullable)
...
Possible enum values:
    ...
    - `payment_method_details.ideal.generated_sepa_debit` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      The ID of the SEPA Direct Debit PaymentMethod which was generated by this Charge.

    - `payment_method_details.ideal.generated_sepa_debit_mandate` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      The mandate for the SEPA Direct Debit PaymentMethod which was generated by this Charge.
  ...
  - `payment_method_details.interac_present` (object, nullable)
    ...
    - `payment_method_details.interac_present.location` (string, nullable)
      ID of the [location](https://docs.stripe.com/docs/api/terminal/locations.md) that this transaction’s reader is assigned to.
...
Possible enum values:
    ...
    - `payment_method_details.interac_present.reader` (string, nullable)
      ID of the [reader](https://docs.stripe.com/docs/api/terminal/readers.md) this transaction was made on.
...
Possible enum values:
  ...
  - `payment_method_details.sofort` (object, nullable)
    ...
    - `payment_method_details.sofort.generated_sepa_debit` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      The ID of the SEPA Direct Debit PaymentMethod which was generated by this Charge.

    - `payment_method_details.sofort.generated_sepa_debit_mandate` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      The mandate for the SEPA Direct Debit PaymentMethod which was generated by this Charge.
...
Possible enum values:
    ...
    - `payment_method_details.us_bank_account.mandate` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
      ID of the mandate used to make this payment.
