...
A platform can only access a subset of data in a person for an account where [account.controller.requirement_collection](accounts/object.md#account_object-controller-requirement_collection) is `stripe`, which includes Standard and Express accounts, after creating an Account Link or Account Session to start Connect onboarding.
...
- [POST /v1/accounts/:id/persons](persons/create.md)

### Update a person

- [POST /v1/accounts/:id/persons/:id](persons/update.md)

### Retrieve a person

- [GET /v1/accounts/:id/persons/:id](persons/retrieve.md)

### List all persons

- [GET /v1/accounts/:id/persons](persons/list.md)

### Delete a person

- [DELETE /v1/accounts/:id/persons/:id](persons/delete.md)
