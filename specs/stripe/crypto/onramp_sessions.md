...
- [POST /v1/crypto/onramp_sessions](onramp_sessions/create.md)

### Retrieve a CryptoOnrampSession

- [GET /v1/crypto/onramp_sessions/:id](onramp_sessions/retrieve.md)

### List CryptoOnrampSessions

- [GET /v1/crypto/onramp_sessions](onramp_sessions/list.md)
