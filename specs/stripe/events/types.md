...
- `application_fee.refunded`
  ...
  Occurs whenever an application fee is refunded, whether from refunding a charge or from [refunding the application fee directly](types.md#fee_refunds). This includes partial refunds.
