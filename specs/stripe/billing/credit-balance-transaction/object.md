...
Possible enum values:
  ...
  - `credit.credits_application_invoice_voided` (object, nullable)
    ...
    - `credit.credits_application_invoice_voided.invoice` (string, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
  ...
  - `debit.credits_applied` (object, nullable)
    ...
    - `debit.credits_applied.invoice` (string, expandable (can be expanded into an object with the `expand` request parameter))
