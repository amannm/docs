...
Returns the Customer object after successful customer creation. Raises [an error](create.md#errors) if create parameters are invalid (for example, specifying an invalid source).
