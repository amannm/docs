...
- `evidence` (object)
  ...
  - `evidence.cancellation_policy` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  ...
  - `evidence.customer_communication` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  ...
  - `evidence.customer_signature` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) A relevant document or contract showing the customer’s signature.

  - `evidence.duplicate_charge_documentation` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
  ...
  - `evidence.receipt` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Any receipt or message sent to the customer notifying them of the charge.

  - `evidence.refund_policy` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  ...
  - `evidence.service_documentation` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  ...
  - `evidence.shipping_documentation` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  ...
  - `evidence.uncategorized_file` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
