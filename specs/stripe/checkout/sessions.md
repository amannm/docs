...
- [POST /v1/checkout/sessions](sessions/create.md)

### Update a Checkout Session

- [POST /v1/checkout/sessions/:id](sessions/update.md)

### Retrieve a Checkout Session

- [GET /v1/checkout/sessions/:id](sessions/retrieve.md)

### Retrieve a Checkout Session's line items

- [GET /v1/checkout/sessions/:id/line_items](sessions/line_items.md)

### List all Checkout Sessions

- [GET /v1/checkout/sessions](sessions/list.md)

### Expire a Checkout Session

- [POST /v1/checkout/sessions/:id/expire](sessions/expire.md)
