...
- [POST /v1/sources](sources/create.md)

### Update a source

- [POST /v1/sources/:id](sources/update.md)

### Retrieve a source

- [GET /v1/sources/:id](sources/retrieve.md)

### Attach a source

- [POST /v1/customers/:id/sources](sources/attach.md)

### Detach a source

- [DELETE /v1/customers/:id/sources/:id](sources/detach.md)
