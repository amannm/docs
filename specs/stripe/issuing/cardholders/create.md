  ...
  - `individual.verification` (object, optional)
    ...
    - `individual.verification.document` (object, optional)
      ...
      - `individual.verification.document.back` (string, optional)
        The back of an ID returned by a [file upload](create.md#create_file) with a `purpose` value of `identity_document`.

      - `individual.verification.document.front` (string, optional)
        The front of an ID returned by a [file upload](create.md#create_file) with a `purpose` value of `identity_document`.
