  ...
  - `cardholder.individual` (object, nullable)
    ...
    - `cardholder.individual.verification` (object, nullable)
      ...
      - `cardholder.individual.verification.document` (object, nullable)
        ...
        - `cardholder.individual.verification.document.back` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
          The back of a document returned by a [file upload](object.md#create_file) with a `purpose` value of `identity_document`.

        - `cardholder.individual.verification.document.front` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
