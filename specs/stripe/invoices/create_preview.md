...
Returns an invoice if valid customer information is provided. Raises [an error](create_preview.md#errors) otherwise.
...
Possible enum values:
  ...
  - `invoice_items.quantity_decimal` (string, optional)
