...
This endpoint creates a draft invoice for a given customer. The invoice remains a draft until you [finalize](create.md#finalize_invoice) the invoice, which allows you to [pay](pay.md) or [send](send.md) the invoice to your customers.

## Returns

Returns the invoice object. Raises [an error](create.md#errors) if the customer ID provided is invalid.
