...
The updated invoice with newly added line items is returned upon success. Otherwise, this call raises [an error](bulk.md#errors).
...
Possible enum values:
  ...
  - `lines.quantity_decimal` (string, optional)
