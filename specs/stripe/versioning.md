...
Webhook events also use your account’s API version by default, unless you set an API version during [endpoint creation](webhook_endpoints/create.md).
...
Webhook events also use your account’s API version by default unless you set an API version when [creating the endpoint](webhook_endpoints/create.md).
