...
They contain [invoice items](invoices.md#invoiceitems), and proration adjustments that may be caused by subscription upgrades/downgrades (if necessary).
...
- [POST /v1/invoices/create_preview](invoices/create_preview.md)

### Create an invoice

- [POST /v1/invoices](invoices/create.md)

### Update an invoice

- [POST /v1/invoices/:id](invoices/update.md)

### Retrieve an invoice

- [GET /v1/invoices/:id](invoices/retrieve.md)

### List all invoices

- [GET /v1/invoices](invoices/list.md)

### Delete a draft invoice

- [DELETE /v1/invoices/:id](invoices/delete.md)

### Attach a payment to an Invoice

- [POST /v1/invoices/:id/attach_payment](invoices/attach_payment.md)

### Finalize an invoice

- [POST /v1/invoices/:id/finalize](invoices/finalize.md)

### Mark an invoice as uncollectible

- [POST /v1/invoices/:id/mark_uncollectible](invoices/mark_uncollectible.md)

### Pay an invoice

- [POST /v1/invoices/:id/pay](invoices/pay.md)

### Search invoices

- [GET /v1/invoices/search](invoices/search.md)

### Send an invoice for manual payment

- [POST /v1/invoices/:id/send](invoices/send.md)

### Void an invoice

- [POST /v1/invoices/:id/void](invoices/void.md)
