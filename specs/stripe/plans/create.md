...
You can now model subscriptions more flexibly using the [Prices API](create.md#prices). It replaces the Plans API and is backwards compatible to simplify your migration.
