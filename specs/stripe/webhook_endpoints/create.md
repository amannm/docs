...
Possible enum values:
  ...
  - `application_fee.refunded`
    Occurs whenever an application fee is refunded, whether from refunding a charge or from [refunding the application fee directly](create.md#fee_refunds). This includes partial refunds.
