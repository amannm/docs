...
- `components` (object)
  ...
  - `components.balances` (object)
    ...
    - `components.balances.features` (object)
      ...
      - `components.balances.features.instant_payouts` (enum)
...
Possible enum values:
  ...
  - `components.instant_payouts_promotion` (object)
    ...
    - `components.instant_payouts_promotion.features` (object)
      ...
      - `components.instant_payouts_promotion.features.instant_payouts` (enum)
        Whether to allow creation of instant payouts. Defaults to `true` when `controller.losses.payments` is set to `stripe` for the account, otherwise `false`.
Possible enum values:
        - `disabled`
          Explicitly disable instant payouts in the component, overriding the platform Dashboard settings.
  ...
  - `components.payouts` (object)
    ...
    - `components.payouts.features` (object)
      ...
      - `components.payouts.features.instant_payouts` (enum)
        Whether to allow creation of instant payouts. Defaults to `true` when `controller.losses.payments` is set to `stripe` for the account, otherwise `false`.
Possible enum values:
        - `disabled`
          Explicitly disable instant payouts in the component, overriding the platform Dashboard settings.
