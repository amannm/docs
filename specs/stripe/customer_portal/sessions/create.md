...
- `configuration` (string, optional)
  The ID of an existing [configuration](https://docs.stripe.com/docs/api/customer_portal/configurations.md) to use for this session, describing its functionality and features. If not specified, the session uses the default configuration.
