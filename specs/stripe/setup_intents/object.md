      ...
      - `last_setup_error.payment_method.card.generated_from` (object, nullable)
        ...
        - `last_setup_error.payment_method.card.generated_from.payment_method_details` (object, nullable)
          ...
          - `last_setup_error.payment_method.card.generated_from.payment_method_details.card_present` (object, nullable)
            ...
            - `last_setup_error.payment_method.card.generated_from.payment_method_details.card_present.location` (string, nullable)
...
Possible enum values:
            ...
            - `last_setup_error.payment_method.card.generated_from.payment_method_details.card_present.reader` (string, nullable)
...
Possible enum values:
        ...
        - `last_setup_error.payment_method.card.generated_from.setup_attempt` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
    ...
    - `last_setup_error.payment_method.customer` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
    ...
    - `last_setup_error.payment_method.klarna` (object, nullable)
      ...
      - `last_setup_error.payment_method.klarna.dob` (object, nullable, expandable (can be expanded into an object with the `expand` request parameter))
...
Possible enum values:
    ...
    - `last_setup_error.payment_method.sepa_debit` (object, nullable)
      ...
      - `last_setup_error.payment_method.sepa_debit.generated_from` (object, nullable)
        ...
        - `last_setup_error.payment_method.sepa_debit.generated_from.charge` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
          The ID of the Charge that generated this PaymentMethod, if any.

        - `last_setup_error.payment_method.sepa_debit.generated_from.setup_attempt` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
          The ID of the SetupAttempt that generated this PaymentMethod, if any.
...
- `payment_method` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
  ID of the payment method used with this SetupIntent. If the payment method is `card_present` and isn’t a digital wallet, then the [generated_card](../setup_attempts/object.md#setup_attempt_object-payment_method_details-card_present-generated_card) associated with the `latest_attempt` is attached to the Customer instead.
...
- `payment_method_types` (array of strings)
  The list of payment method types (e.g. card) that this SetupIntent is allowed to set up. A list of valid payment method types can be found [here](../payment_methods/object.md#payment_method_object-type).
