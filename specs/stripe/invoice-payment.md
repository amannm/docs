...
1. By expanding the `payments` field on the [Invoice](invoice-payment.md#invoice) resource.
...
- [GET /v1/invoice_payments/:id](invoice-payment/retrieve.md)

### List all payments for an invoice

- [GET /v1/invoice_payments](invoice-payment/list.md)
