...
- `ids` (array of strings, optional)
  Only return products with the given IDs. Cannot be used with [starting_after](list.md#list_products-starting_after) or [ending_before](list.md#list_products-ending_before).
