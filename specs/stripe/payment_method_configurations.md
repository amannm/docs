...
- [POST /v1/payment_method_configurations](payment_method_configurations/create.md)

### Update payment method configuration

- [POST /v1/payment_method_configurations/:id](payment_method_configurations/update.md)

### Retrieve payment method configuration

- [GET /v1/payment_method_configurations/:id](payment_method_configurations/retrieve.md)

### List payment method configurations

- [GET /v1/payment_method_configurations](payment_method_configurations/list.md)
