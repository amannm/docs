...
- [POST /v1/invoices/:id/lines/:id](invoice-line-item/update.md)

### Retrieve an invoice's line items

- [GET /v1/invoices/:id/lines](invoice-line-item/retrieve.md)

### Bulk add invoice line items

- [POST /v1/invoices/:id/add_lines](invoice-line-item/bulk.md)

### Bulk remove invoice line items

- [POST /v1/invoices/:id/remove_lines](invoice-line-item/invoices/remove-lines/bulk.md)

### Bulk update invoice line items

- [POST /v1/invoices/:id/update_lines](invoice-line-item/invoices/update-lines/bulk.md)
