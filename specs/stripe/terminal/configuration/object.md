...
- `bbpos_wisepad3` (object, nullable)
  ...
  - `bbpos_wisepad3.splashscreen` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    A File ID representing an image to display on the reader

- `bbpos_wisepos_e` (object, nullable)
  An object containing device type specific settings for BBPOS WisePOS E

  - `bbpos_wisepos_e.splashscreen` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    A File ID representing an image to display on the reader

- `cellular` (object, nullable)
...
- `stripe_s700` (object, nullable)
  ...
  - `stripe_s700.splashscreen` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    A File ID representing an image to display on the reader

- `stripe_s710` (object, nullable)
  An object containing device type specific settings for Stripe S710

  - `stripe_s710.splashscreen` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    A File ID representing an image to display on the reader
...
- `verifone_p400` (object, nullable)
  ...
  - `verifone_p400.splashscreen` (string, nullable, expandable (can be expanded into an object with the `expand` request parameter))
    A File ID representing an image to display on the reader
