...
- `country` (string, required)
  Only return Shipping Methods that have the given country. Country must be a two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
...
```curl
curl -G https://api.stripe.com/v1/terminal/hardware_shipping_methods \
  -u "<<YOUR_SECRET_KEY>>" \
  -H "Stripe-Version: 2026-02-25.clover; terminal_hardware_orders_beta=v5" \
  -d country=US
```
