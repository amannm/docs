...
- [POST /v1/payment_method_domains](payment_method_domains/create.md)

### Update a payment method domain

- [POST /v1/payment_method_domains/:id](payment_method_domains/update.md)

### Retrieve a payment method domain

- [GET /v1/payment_method_domains/:id](payment_method_domains/retrieve.md)

### List payment method domains

- [GET /v1/payment_method_domains](payment_method_domains/list.md)

### Validate an existing payment method domain

- [POST /v1/payment_method_domains/:id/validate](payment_method_domains/validate.md)
