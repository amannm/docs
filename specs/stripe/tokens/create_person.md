...
Returns the created person token if it’s successful. Otherwise, this call raises [an error](create_person.md#errors).
  ...
  - `person.documents` (object, optional)
    ...
    - `person.documents.company_authorization` (object, optional)
      ...
      - `person.documents.company_authorization.files` (array of strings, optional)
        One or more document ids returned by a [file upload](create_person.md#create_file) with a `purpose` value of `account_requirement`.
  ...
  - `person.verification` (object, optional)
    ...
    - `person.verification.additional_document` (object, optional)
      ...
      - `person.verification.additional_document.back` (string, optional)
        The back of an ID returned by a [file upload](create_person.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

        The maximum length is 500 characters.

      - `person.verification.additional_document.front` (string, optional)
        The front of an ID returned by a [file upload](create_person.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
