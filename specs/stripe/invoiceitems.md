...
- [POST /v1/invoiceitems](invoiceitems/create.md)

### Update an invoice item

- [POST /v1/invoiceitems/:id](invoiceitems/update.md)

### Retrieve an invoice item

- [GET /v1/invoiceitems/:id](invoiceitems/retrieve.md)

### List all invoice items

- [GET /v1/invoiceitems](invoiceitems/list.md)

### Delete an invoice item

- [DELETE /v1/invoiceitems/:id](invoiceitems/delete.md)
