...
- [POST /v1/customers/:id/tax_ids](tax_ids/customer_create.md)

### Create a tax ID

- [POST /v1/tax_ids](tax_ids/create.md)

### Retrieve a Customer tax ID

- [GET /v1/customers/:id/tax_ids/:id](tax_ids/customer_retrieve.md)

### Retrieve a tax ID

- [GET /v1/tax_ids/:id](tax_ids/retrieve.md)

### List all Customer tax IDs

- [GET /v1/customers/:id/tax_ids](tax_ids/customer_list.md)

### List all tax IDs

- [GET /v1/tax_ids](tax_ids/list.md)

### Delete a Customer tax ID

- [DELETE /v1/customers/:id/tax_ids/:id](tax_ids/customer_delete.md)

### Delete a tax ID

- [DELETE /v1/tax_ids/:id](tax_ids/delete.md)
