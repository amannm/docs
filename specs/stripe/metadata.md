...
Updateable Stripe objects—including [Account](accounts.md), [Charge](charges.md), [Customer](customers.md), [PaymentIntent](payment_intents.md), [Refund](refunds.md), [Subscription](subscriptions.md), and [Transfer](transfers.md) have a `metadata` parameter. You can use this parameter to attach key-value data to these Stripe objects.
