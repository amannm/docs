...
- `available` (array of objects)
  Available funds that you can transfer or pay out automatically by Stripe or explicitly through the [Transfers API](balance_object.md#transfers) or [Payouts API](balance_object.md#payouts). You can find the available balance for each currency and payment type in the `source_types` property.
...
- `issuing` (object, nullable)
  Funds that you can spend on your [Issued Cards](balance_object.md#issuing/cards).
