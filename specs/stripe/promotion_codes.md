...
- [POST /v1/promotion_codes](promotion_codes/create.md)

### Update a promotion code

- [POST /v1/promotion_codes/:id](promotion_codes/update.md)

### Retrieve a promotion code

- [GET /v1/promotion_codes/:id](promotion_codes/retrieve.md)

### List all promotion codes

- [GET /v1/promotion_codes](promotion_codes/list.md)
