...
- [POST /v2/core/accounts](accounts/create.md)

### Update an Account

- [POST /v2/core/accounts/:id](accounts/update.md)

### Retrieve an Account

- [GET /v2/core/accounts/:id](accounts/retrieve.md)

### List Accounts

- [GET /v2/core/accounts](accounts/list.md)

### Close an Account

- [POST /v2/core/accounts/:id/close](accounts/close.md)
