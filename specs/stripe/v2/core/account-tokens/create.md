  ...
  - `identity.business_details` (object, optional)
    ...
    - `identity.business_details.annual_revenue` (object, optional)
      ...
      - `identity.business_details.annual_revenue.amount` (object, optional)
        ...
        - `identity.business_details.annual_revenue.amount.currency` (enum, required)
...
Possible enum values:
      ...
      - `identity.business_details.documents.primary_verification` (object, optional)
        ...
        - `identity.business_details.documents.primary_verification.front_back` (object, required)
          The [file upload](../../../persons/update.md#create_file) tokens referring to each side of the document.
...
Possible enum values:
    ...
    - `identity.business_details.monthly_estimated_revenue` (object, optional)
      ...
      - `identity.business_details.monthly_estimated_revenue.amount` (object, optional)
        ...
        - `identity.business_details.monthly_estimated_revenue.amount.currency` (enum, required)
          Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
    ...
    - `identity.business_details.registration_date` (object, optional)
      When the business was incorporated or registered.

      - `identity.business_details.registration_date.day` (integer, required)
        The day of registration, between 1 and 31.

      - `identity.business_details.registration_date.month` (integer, required)
        The month of registration, between 1 and 12.

      - `identity.business_details.registration_date.year` (integer, required)
