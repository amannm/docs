...
Related object: [Account](object.md)
...
- `changes` (object)
  Changes that the event makes to properties in the related object. See the [Account](object.md) object for the structure of `before` and `after`.
