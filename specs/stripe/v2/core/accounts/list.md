    ...
    - `data.configuration.merchant` (object, nullable)
      ...
      - `data.configuration.merchant.branding` (object, nullable)
        ...
        - `data.configuration.merchant.branding.icon` (string, nullable)
          ID of a [file upload](../../../persons/update.md#create_file): An icon for the merchant. Must be square and at least 128px x 128px.

        - `data.configuration.merchant.branding.logo` (string, nullable)
          ID of a [file upload](../../../persons/update.md#create_file): A logo for the merchant that will be used in Checkout instead of the icon and without the merchant’s name next to it if provided. Must be at least 128px x 128px.
...
Possible enum values:
  ...
  - `data.contact_phone` (string, nullable)
    ...
    - `data.identity.business_details` (object, nullable)
      ...
      - `data.identity.business_details.annual_revenue` (object, nullable)
        ...
        - `data.identity.business_details.annual_revenue.amount` (object, nullable)
          ...
          - `data.identity.business_details.annual_revenue.amount.currency` (enum)
            Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
      ...
      - `data.identity.business_details.documents` (object, nullable)
        ...
        - `data.identity.business_details.documents.bank_account_ownership_verification` (object, nullable)
          ...
          - `data.identity.business_details.documents.bank_account_ownership_verification.files` (array of strings)
            One or more document IDs returned by a [file upload](../../../persons/update.md#create_file) with a purpose value of `account_requirement`.
...
Possible enum values:
        ...
        - `data.identity.business_details.documents.primary_verification` (object, nullable)
          ...
          - `data.identity.business_details.documents.primary_verification.front_back` (object)
            The [file upload](../../../persons/update.md#create_file) tokens for the front and back of the verification document.

            - `data.identity.business_details.documents.primary_verification.front_back.back` (string, nullable)
              A [file upload](../../../persons/update.md#create_file) token representing the back of the verification document. The purpose of the uploaded file should be ‘identity_document’. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

            - `data.identity.business_details.documents.primary_verification.front_back.front` (string)
              A [file upload](../../../persons/update.md#create_file) token representing the front of the verification document. The purpose of the uploaded file should be ‘identity_document’. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
...
Possible enum values:
          ...
          - `gb_vat`
            VAT registration number - United Kingdom.
      ...
      - `data.identity.business_details.monthly_estimated_revenue` (object, nullable)
        ...
        - `data.identity.business_details.monthly_estimated_revenue.amount` (object, nullable)
          ...
          - `data.identity.business_details.monthly_estimated_revenue.amount.currency` (enum)
            Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
      ...
      - `data.identity.business_details.registration_date` (object, nullable)
        When the business was incorporated or registered.

        - `data.identity.business_details.registration_date.day` (integer)
          The day of registration, between 1 and 31.

        - `data.identity.business_details.registration_date.month` (integer)
          The month of registration, between 1 and 12.

        - `data.identity.business_details.registration_date.year` (integer)
