...
You can access events through the [Retrieve Event API](events.md#retrieve_event) for 30 days.

## Endpoints

### Retrieve an event

- [GET /v1/events/:id](events/retrieve.md)

### List all events

- [GET /v1/events](events/list.md)
