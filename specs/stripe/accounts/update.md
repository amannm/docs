...
For accounts where [controller.requirement_collection](object.md#account_object-controller-requirement_collection) is `application`, which includes Custom accounts, you can update any information on the account.

For accounts where [controller.requirement_collection](object.md#account_object-controller-requirement_collection) is `stripe`, which includes Standard and Express accounts, you can update all information until you create an [Account Link](../account_links.md) or [Account Session](../account_sessions.md) to start Connect onboarding, after which some properties can no longer be updated.
...
Returns an [`Account`](update.md#account_object) object if the call succeeds. If the account ID does not exist or another issue occurs, this call raises [an error](update.md#errors). Some validations will not raise an error but will instead populate the [`requirements.errors`](update.md#account_object-requirements-errors) array.

## Parameters

- `account_token` (string, optional)
  An [account token](update.md#create_account_token), used to securely provide details to the account.
...
- `business_type` (enum, optional)
  The business type. Once you create an [Account Link](../account_links.md) or [Account Session](../account_sessions.md), this property can only be updated for accounts where [controller.requirement_collection](object.md#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
Possible enum values:
  - `company`
  - `government_entity`
    US only
...
- `capabilities` (object, optional)
  ...
  Required when [account.controller.stripe_dashboard.type](create.md#create_account-controller-dashboard-type) is `none`, which includes Custom accounts.

  - `capabilities.acss_debit_payments` (object, optional)
    The acss_debit_payments capability.

    - `capabilities.acss_debit_payments.preview` (boolean, optional)
  ...
  - `capabilities.affirm_payments` (object, optional)
    ...
    - `capabilities.affirm_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.afterpay_clearpay_payments` (object, optional)
    ...
    - `capabilities.afterpay_clearpay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.alma_payments` (object, optional)
    ...
    - `capabilities.alma_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.amazon_pay_payments` (object, optional)
    ...
    - `capabilities.amazon_pay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.au_becs_debit_payments` (object, optional)
    ...
    - `capabilities.au_becs_debit_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.bacs_debit_payments` (object, optional)
    ...
    - `capabilities.bacs_debit_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.bancontact_payments` (object, optional)
    ...
    - `capabilities.bancontact_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.bank_transfer_payments` (object, optional)
    ...
    - `capabilities.bank_transfer_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.billie_payments` (object, optional)
    ...
    - `capabilities.billie_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.blik_payments` (object, optional)
    ...
    - `capabilities.blik_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.boleto_payments` (object, optional)
    ...
    - `capabilities.boleto_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.card_issuing` (object, optional)
    ...
    - `capabilities.card_issuing.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.card_payments` (object, optional)
    ...
    - `capabilities.card_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.cartes_bancaires_payments` (object, optional)
    ...
    - `capabilities.cartes_bancaires_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.cashapp_payments` (object, optional)
    ...
    - `capabilities.cashapp_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.crypto_payments` (object, optional)
    ...
    - `capabilities.crypto_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.eps_payments` (object, optional)
    ...
    - `capabilities.eps_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.fpx_payments` (object, optional)
    ...
    - `capabilities.fpx_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.gb_bank_transfer_payments` (object, optional)
    ...
    - `capabilities.gb_bank_transfer_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.giropay_payments` (object, optional)
    ...
    - `capabilities.giropay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.grabpay_payments` (object, optional)
    ...
    - `capabilities.grabpay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.ideal_payments` (object, optional)
    ...
    - `capabilities.ideal_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.india_international_payments` (object, optional)
    ...
    - `capabilities.india_international_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.jcb_payments` (object, optional)
    ...
    - `capabilities.jcb_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.jp_bank_transfer_payments` (object, optional)
    ...
    - `capabilities.jp_bank_transfer_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.kakao_pay_payments` (object, optional)
    ...
    - `capabilities.kakao_pay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.klarna_payments` (object, optional)
    ...
    - `capabilities.klarna_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.konbini_payments` (object, optional)
    ...
    - `capabilities.konbini_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.kr_card_payments` (object, optional)
    ...
    - `capabilities.kr_card_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.legacy_payments` (object, optional)
    ...
    - `capabilities.legacy_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.link_payments` (object, optional)
    ...
    - `capabilities.link_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.mb_way_payments` (object, optional)
    ...
    - `capabilities.mb_way_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.mobilepay_payments` (object, optional)
    ...
    - `capabilities.mobilepay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.multibanco_payments` (object, optional)
    ...
    - `capabilities.multibanco_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.mx_bank_transfer_payments` (object, optional)
    ...
    - `capabilities.mx_bank_transfer_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.naver_pay_payments` (object, optional)
    ...
    - `capabilities.naver_pay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.nz_bank_account_becs_debit_payments` (object, optional)
    ...
    - `capabilities.nz_bank_account_becs_debit_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.oxxo_payments` (object, optional)
    ...
    - `capabilities.oxxo_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.p24_payments` (object, optional)
    ...
    - `capabilities.p24_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.pay_by_bank_payments` (object, optional)
    ...
    - `capabilities.pay_by_bank_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.payco_payments` (object, optional)
    ...
    - `capabilities.payco_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.paynow_payments` (object, optional)
    ...
    - `capabilities.paynow_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.payto_payments` (object, optional)
    ...
    - `capabilities.payto_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.pix_payments` (object, optional)
    ...
    - `capabilities.pix_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.promptpay_payments` (object, optional)
    ...
    - `capabilities.promptpay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.revolut_pay_payments` (object, optional)
    ...
    - `capabilities.revolut_pay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.samsung_pay_payments` (object, optional)
    ...
    - `capabilities.samsung_pay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.satispay_payments` (object, optional)
    ...
    - `capabilities.satispay_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.sepa_bank_transfer_payments` (object, optional)
    ...
    - `capabilities.sepa_bank_transfer_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.sepa_debit_payments` (object, optional)
    ...
    - `capabilities.sepa_debit_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.sofort_payments` (object, optional)
    ...
    - `capabilities.sofort_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.swish_payments` (object, optional)
    ...
    - `capabilities.swish_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.tax_reporting_us_1099_k` (object, optional)
    ...
    - `capabilities.tax_reporting_us_1099_k.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.tax_reporting_us_1099_misc` (object, optional)
    ...
    - `capabilities.tax_reporting_us_1099_misc.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.transfers` (object, optional)
    ...
    - `capabilities.transfers.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.twint_payments` (object, optional)
    ...
    - `capabilities.twint_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.us_bank_account_ach_payments` (object, optional)
    ...
    - `capabilities.us_bank_account_ach_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.us_bank_transfer_payments` (object, optional)
    ...
    - `capabilities.us_bank_transfer_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
  ...
  - `capabilities.zip_payments` (object, optional)
    ...
    - `capabilities.zip_payments.preview` (boolean, optional)
      Passing true assigns the preview onboarding policy to the capability.
...
- `company` (object, optional)
  Information about the company or business. This field is available for any `business_type`. Once you create an [Account Link](../account_links.md) or [Account Session](../account_sessions.md), this property can only be updated for accounts where [controller.requirement_collection](object.md#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
  ...
  - `company.directors_provided` (boolean, optional)
    Whether the company’s directors have been provided. Set this Boolean to `true` after creating all the company’s directors with [the Persons API](../persons.md) for accounts with a `relationship.director` requirement. This value is not automatically set to `true` after creating directors, so it needs to be updated to indicate all directors have been provided.
  ...
  - `company.executives_provided` (boolean, optional)
    Whether the company’s executives have been provided. Set this Boolean to `true` after creating all the company’s executives with [the Persons API](../persons.md) for accounts with a `relationship.executive` requirement.
  ...
  - `company.owners_provided` (boolean, optional)
    Whether the company’s owners have been provided. Set this Boolean to `true` after creating all the company’s owners with [the Persons API](../persons.md) for accounts with a `relationship.owner` requirement.
  ...
  - `company.verification` (object, optional)
    ...
    - `company.verification.document` (object, optional)
      ...
      - `company.verification.document.back` (string, optional)
        The back of a document returned by a [file upload](update.md#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

        The maximum length is 500 characters.

      - `company.verification.document.front` (string, optional)
        The front of a document returned by a [file upload](update.md#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
...
- `email` (string, optional)
  The email address of the account holder. This is only to make the account easier to identify to you. If [controller.requirement_collection](object.md#account_object-controller-requirement_collection) is `application`, which includes Custom accounts, Stripe doesn’t email the account without your consent.

  The maximum length is 800 characters.

- `external_account` (string, optional)
  A card or bank account to attach to the account for receiving [payouts](https://docs.stripe.com/connect/bank-debit-card-payouts.md) (you won’t be able to use it for top-ups). You can provide either a token, like the ones returned by [Stripe.js](https://docs.stripe.com/js.md), or a dictionary, as documented in the `external_account` parameter for [bank account](../index.md#account_create_bank_account) creation. By default, providing an external account sets it as the new default external account for its currency, and deletes the old default if one exists. To add additional external accounts without replacing the existing default for the currency, use the [bank account](../index.md#account_create_bank_account) or [card creation](../index.md#account_create_card) APIs. After you create an [Account Link](../account_links.md) or [Account Session](../account_sessions.md), this property can only be updated for accounts where [controller.requirement_collection](object.md#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
...
- `individual` (object, optional)
  Information about the person represented by the account. This field is null unless `business_type` is set to `individual`. Once you create an [Account Link](../account_links.md) or [Account Session](../account_sessions.md), this property can only be updated for accounts where [controller.requirement_collection](object.md#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
  ...
  - `individual.verification` (object, optional)
    ...
    - `individual.verification.additional_document` (object, optional)
      ...
      - `individual.verification.additional_document.back` (string, optional)
        The back of an ID returned by a [file upload](update.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

        The maximum length is 500 characters.

      - `individual.verification.additional_document.front` (string, optional)
        The front of an ID returned by a [file upload](update.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
