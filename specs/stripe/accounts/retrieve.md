...
Returns an [`Account`](retrieve.md#account_object) object if the call succeeds. If the account ID does not exist, this call raises [an error](retrieve.md#errors).
