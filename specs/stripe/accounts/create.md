...
Returns an [`Account`](create.md#account_object) object if the call succeeds.

## Parameters

- `account_token` (string, optional)
  An [account token](create.md#create_account_token), used to securely provide details to the account.
  ...
  - `company.verification` (object, optional)
    ...
    - `company.verification.document` (object, optional)
      ...
      - `company.verification.document.back` (string, optional)
        The back of a document returned by a [file upload](create.md#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

        The maximum length is 500 characters.

      - `company.verification.document.front` (string, optional)
        The front of a document returned by a [file upload](create.md#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
  ...
  - `individual.verification` (object, optional)
    ...
    - `individual.verification.additional_document` (object, optional)
      ...
      - `individual.verification.additional_document.back` (string, optional)
        The back of an ID returned by a [file upload](create.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

        The maximum length is 500 characters.

      - `individual.verification.additional_document.front` (string, optional)
        The front of an ID returned by a [file upload](create.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
