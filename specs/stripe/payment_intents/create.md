...
Possible enum values:
  ...
  - `payment_method_options.affirm` (object, optional)
    ...
    - `payment_method_options.affirm.capture_method` (enum, optional)
      ...
      If provided, this parameter overrides the behavior of the top-level [capture_method](update.md#update_payment_intent-capture_method) for this payment method type when finalizing the payment with this payment method type.
...
- `payment_method_types` (array of strings, optional)
  The list of payment method types (for example, a card) that this PaymentIntent can use. If you don’t provide this, Stripe will dynamically show relevant payment methods from your [payment method settings](https://dashboard.stripe.com/settings/payment_methods). A list of valid payment method types can be found [here](../payment_methods/object.md#payment_method_object-type).
