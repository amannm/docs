...
- [POST /v1/transfers/:id/reversals](transfer_reversals/create.md)

### Update a reversal

- [POST /v1/transfers/:id/reversals/:id](transfer_reversals/update.md)

### Retrieve a reversal

- [GET /v1/transfers/:id/reversals/:id](transfer_reversals/retrieve.md)

### List all reversals

- [GET /v1/transfers/:id/reversals](transfer_reversals/list.md)
